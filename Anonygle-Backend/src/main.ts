...
import { HttpExceptionFilter } from "./catch/globalHTTPcatcher"
import { RateLimitMiddleware } from "./middleware/ratelimit.middleware"
import * as cookieParser from 'cookie-parser'
import { WebSocketExceptionFilter } from "./catch/globalWebSocketcatcher"
...
async function bootstrap() {
  ...
  app.useGlobalFilters(new WebSocketExceptionFilter(new Logger()))
